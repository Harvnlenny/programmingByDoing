...
public class FunctionCallAlphabet
{
  public static void main( String[] args )
  {
    ...
    n("Node");    // displays the word you pass it beginning with "N"
    ...
    t("Turkey");    // displays the word you pass it beginning with "T"
    System.out.print(u());    // returns the word to be displayed
    v(1);    // tell it how many times to display the word (1)
    w(32);    // pass it any integer and it will display a word beginning with W 
